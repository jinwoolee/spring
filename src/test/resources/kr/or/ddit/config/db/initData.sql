...
Insert into USERS (USERID,USERNM,PASS,REG_DT,ALIAS,ADDR1,ADDR2,ZIPCODE,FILENAME,REALFILENAME) values ('ljw','이진우','pass1234',to_date('2020-11-09','YYYY-MM-DD'),'sem','대전 중구 중앙로 76','영민빌딩 4층 404호','34904',null,null);
